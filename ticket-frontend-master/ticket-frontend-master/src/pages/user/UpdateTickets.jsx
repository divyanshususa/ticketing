...
const UpdateTickets = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      res.data.ticket.forEach((ticket) => {
        ...
        initialResolvedDescriptionMap[ticket._id] =
  ...
  const handleResolve = async (ticketId) => {
    try {
      ...
      const response = await Axios.post("/api/resolvedTicket", payload, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
            ...
            <tr key={ticket._id}>
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <select
                  ...
                  onChange={(e) =>
                    handleResolvedStatusChange(ticket._id, e.target.value)
                  }
                >
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <input
                  ...
                  onChange={(e) =>
                    handleResolvedDescriptionChange(ticket._id, e.target.value)
                  }
                />
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
